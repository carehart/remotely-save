...
Additionally, the plugin author may occasionally visit the Obsidian official forum and official Discord server, to pay attention to information related to thisplugin there.
...
- Option #4: [![BuildCI](https://github.com/fyears/remotely-save/actions/workflows/auto-build.yml/badge.svg)](https://github.com/fyears/remotely-save/actions/workflows/auto-build.yml) All changed files are listed under "artifacts" in the summary for each successful build. The build is automatically generated by every commit, so beware each build may break something.
